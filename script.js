            ...
            function textMode(clone) {
                ...
                for (const child of clone.children) {
                    ...
                    if (!child.className.includes("bonus-attachment-blank-bonus-25")) {
                        ...
                        prog.style.left = "0";
                        prog.style.right = "0";
                        prog.value = Number(percentText.substring(0, percentText.length - 1)) - ranges[bonusText].min
                        prog.max = ranges[bonusText].max - ranges[bonusText].min
...
function init() {
    if (!document.getElementById("AIDSstyle")) {
